...
public class PanelChi extends JFrame{

	public PanelEntrada panelEntrada;
	PanelTabla panelCentro;
	private ChiPrueba chiPrueba;
	...
	public PanelChi(){
		...
		panelCentro = new PanelTabla("Chi Cuadrada");
	...
	public void correrMetodo(){
		...
		try{
			...
			chiPrueba.metodo(n, porcentaje, panelCentro,panelEntrada.textArea);
		} catch(Exception e){
			e.printStackTrace();
		}
