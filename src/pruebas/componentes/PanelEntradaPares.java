...
public class PanelEntradaPares extends JPanel{

	public JTextField tfDatos;
	public JTextField tfError;
	public JTextArea textArea;
	public JButton btnGenerar;
	public JTextField tfDivisiones;

	public PanelEntradaPares(){
...
//		panelDatos.setBackground(Color.RED);
		...
		tfDivisiones = new JTextField(15);
        ...
        panelDatos.add(new JLabel("Divisiones"),gbc);
        panelDatos.add(tfDivisiones,gbc);
